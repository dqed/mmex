                        ...
                        <div class="panel-heading">
                            ...
                            <form class="form-inline">
							  <div class="form-group">
							  	    <label for="exampleInputName2">充值报表:</label>
                        ...
                        <div class="panel-body">
                           <ul class="nav nav-tabs">
                                <?php if(is_array($gameinfo)): $i = 0; $__LIST__ = $gameinfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(($vo["id"] == 1)): ?><li class="active"><a href="#home" data-toggle="tab" data-gameid=<?php echo ($vo["id"]); ?>><?php echo ($vo["gamename"]); ?></a>
	                                <?php else: ?>
	                                	<li><a href="#home" data-toggle="tab" data-gameid=<?php echo ($vo["id"]); ?>><?php echo ($vo["gamename"]); ?></a><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                            </ul>
				                                    ...
				                                    <tbody id="table_main" class="table_main">
				                                    	<?php if(is_array($resdata)): $k = 0; $__LIST__ = $resdata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vos): $mod = ($k % 2 );++$k;?><tr class="odd gradeX">
					                                            <td>
					                                            		...
					                                            		<?php echo ($vos["paytime"]); ?>
					                                            </td>
					                                            <td class="center"><?php echo ($vos["payplayers"]); ?></td>
					                                            <td class="center"><?php echo ($vos["paynums"]); ?></td>
					                                            <td class="center"><?php echo ($vos["paymoney"]); ?></td>
					                                            <td class="center"><?php echo ($vos["newpayplayers"]); ?></td>
					                                            <td class="center"><?php echo ($vos["newpaynums"]); ?></td>
					                                            <td class="center"><?php echo ($vos["newpaymoney"]); ?></td>
	...
	<button type="button" class="btn btn-default" id="gonextx">
        ...
        <script type="text/javascript">
        	window.onload=function(){
        		new loadSource("/Public/qpht/assets/js/recharge.js");
        	}
        </script>
